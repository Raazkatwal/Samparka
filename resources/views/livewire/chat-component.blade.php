<div>
    <div style="overscroll-behavior: none;">
        <div class="fixed w-full bg-[#37AE47] h-16 pt-2 text-white flex justify-between shadow-md"
        ...
        <div class="mt-20 mb-16">
            ...
            <div class="clearfix w-4/4">
                <div class="text-right">
                    <p class="bg-[#37AE47] mx-4 my-2 p-2 rounded-lg inline-block">{{$message['message']}}</p>
                </div>
            </div>
